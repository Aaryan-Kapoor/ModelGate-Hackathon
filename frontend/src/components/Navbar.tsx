      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-14 items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="h-7 w-7 rounded-md bg-primary/90 flex items-center justify-center glow-cyan transition-all group-hover:scale-105">
              <span className="text-primary-foreground font-bold text-[10px] tracking-tight">MG</span>
            </div>
            <span className="text-sm font-semibold tracking-tight">ModelGate</span>
            <span className="text-[10px] text-muted-foreground font-mono bg-secondary px-1.5 py-0.5 rounded">v0.1</span>
          </Link>
          <div className="flex items-center gap-0.5">
            ...
            <div className="ml-3 flex items-center gap-1.5 text-[10px] text-muted-foreground font-mono">
